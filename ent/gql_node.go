...
var settingsImplementors = []string{"Settings", "Node"}

// IsNode implements the Node interface check for GQLGen.
func (*Settings) IsNode() {}
...
func (c *Client) noder(ctx context.Context, table string, id int) (Noder, error) {
	...
	case settings.Table:
		...
		if fc := graphql.GetFieldContext(ctx); fc != nil {
			if err := query.collectField(ctx, true, graphql.GetOperationContext(ctx), fc.Field, nil, settingsImplementors...); err != nil {
				return nil, err
			}
		}
...
func (c *Client) noders(ctx context.Context, table string, ids []int) ([]Noder, error) {
	...
	case settings.Table:
		...
		query, err := query.CollectFields(ctx, settingsImplementors...)
		if err != nil {
			return nil, err
		}
